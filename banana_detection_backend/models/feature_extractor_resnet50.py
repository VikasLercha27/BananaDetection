...
def preprocess_image(image_path):
    ...
    if img is None:
        return None
    img = cv2.resize(img, (224, 224))  # ResNet uses 224x224
...
if __name__ == "__main__":
    ...
    print("Feature extraction started (ResNet50)")
    ...
    np.save("models/resnet/classes.npy", np.array(classes))

    print("Feature extraction completed and saved (ResNet50)")