...
FEATURE_DIR = "features/efficientnet"
...
def preprocess_image(image_path):
    ...
    if img is None:
        return None
    img = cv2.resize(img, (224, 224))  # EfficientNet uses 224x224
...
# ----------------------------
# RUN ONLY IF SCRIPT EXECUTED
# ----------------------------
if __name__ == "__main__":

    print("Feature extraction started (EfficientNetB0)")
    ...
    np.save("models/efficientnet/classes.npy", np.array(classes))

    print("Feature extraction completed and saved (EfficientNetB0)")